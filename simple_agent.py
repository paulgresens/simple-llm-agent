...
Evaluate how well the claim is grounded in the context. For each of the provided criteria provided below, you should rate on a scale of 1-3 how well it is fullfilled. The scores have the following meaning:
...
Each "<1-3>" bracket should be replaced with the score of the corresponding metric, also following valid JSON structure. 
